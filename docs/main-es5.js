(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function dx(module, __webpack_exports__, __webpack_require__) {
      ...
      var _categorias_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], CategoriasComponent);
      /***/
    },
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /home/alex/Documentos/threemillion/deploy/blog-angular/src/main.ts */
      "zUnb");
      /***/
    },
    ...
    /***/
    function weG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function cc(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_user_edit_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./user-edit.component.html */
      "5NoG");
      /* harmony import */


      var _user_edit_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _services_apiglobal__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../services/apiglobal */
      "XvYk");
      ...
      var UserEditComponent = /*#__PURE__*/function () {
        function UserEditComponent(_userService) {
          ...
          this.opcionesfroala = {
            ...
            toolbarButtons: {
              'moreText': {
                'buttons': ['bold', 'italic', 'underline', 'strikeThrough', 'paragraphFormat', 'superscript', 'fontFamily', 'fontSize', 'textColor', 'backgroundColor', 'inlineClass', 'inlineStyle', 'clearFormatting']
              }
            }
          };
          this.afuConfig = {
        ...
        _createClass(UserEditComponent, [{
          ...
          key: "enviarUpdateUser",
          value: function enviarUpdateUser(form) {
            var _this = this;

            this._userService.updateuser(this.token, this.user).subscribe(function (response) {
              _this.status = "success";
              console.log("WELL Update user", response);

              if (response.status == 'success') {
                _this.identity.userall = _this.user;
                _this.identity.name = _this.user.name;
                _this.identity.surname = _this.user.surname;
                _this.identity.email = _this.user.email;
                console.log(_this.identity.userall);
                console.log("toke", _this.identity);
                localStorage.setItem('identity', JSON.stringify(_this.identity));
              }
            }, function (error) {
              console.log("Error Update user", error);
              _this.status = "Hya un error en algun lado ajjaja arregls";
            });
          }
        }, {
          key: "ImagenUpload",
          value: function ImagenUpload(datos) {
      ...
      UserEditComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"]])], UserEditComponent);
      /***/
    },
    ...
    /***/
    function AdY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _error_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./error.component.css */
      "csMw");
      /* harmony import */
      ...
      ErrorComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-error',
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], ErrorComponent);
      /***/
    },
    ...
    /***/
    function aX5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function xWU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function BNuL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_post_new_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./post-new.component.html */
      "7aX5");
      /* harmony import */


      var _post_new_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./post-new.component.css */
      "0weG");
      /* harmony import */
      ...
      var src_app_models_post__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/models/post */
      "FNOU");
      /* harmony import */


      var _services_apiglobal__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../services/apiglobal */
      "XvYk");
      /* harmony import */
      ...
      var PostNewComponent = /*#__PURE__*/function () {
        function PostNewComponent(_route, _activeRouter, _userService, _categoryService, _postService) {
          ...
          this.token = _userService.getToken();
          this.identity = _userService.getIdentity();
          this.post = new src_app_models_post__WEBPACK_IMPORTED_MODULE_7__["Post"](1, this.identity.sub, 1, '', '', ''); // console.log(this.token );
        }
        ...
        _createClass(PostNewComponent, [{
          ...
          value: function getCategories() {
            ...
            this._categoryService.getCategories().subscribe(function (response) {
              ...
              _this2.categories = response.categories;
            });
          }
        }, {
          key: "newpost",
          value: function newpost(form) {
            var _this3 = this;
          ...
          key: "ImagenUpload",
          value: function ImagenUpload(datos) {
            var image_data = JSON.parse(datos.response);
      ...
      PostNewComponent.ctorParameters = function () {
        return [{
      ...
      PostNewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"], _services_category_service__WEBPACK_IMPORTED_MODULE_6__["CategoryService"], _services_post_service__WEBPACK_IMPORTED_MODULE_9__["PostService"]])], PostNewComponent);
      /***/
    },
    ...
    function BuFo(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_apiglobal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../services/apiglobal */
      "XvYk");
      /* harmony import */
        ...
        _createClass(HomeComponent, [{
          ...
          value: function getPosts() {
            ...
            this._postService.getPosts().subscribe(function (response) {
              if (response.status == 'success') {
                // console.log(response);
                _this4.posts = response.posts; //console.log(this.posts);
              }
            }, function (error) {});
          }
        }, {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_post_service__WEBPACK_IMPORTED_MODULE_4__["PostService"], src_app_services_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"]])], HomeComponent);
      /***/
    },
    ...
    function DZ0t(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfileComponent = /*#__PURE__*/function () {
        function ProfileComponent(_activeRoute, _postService, _userService) {
          _classCallCheck(this, ProfileComponent);

          this._activeRoute = _activeRoute;
          this._postService = _postService;
          this._userService = _userService;
          this.iduser = +_activeRoute.snapshot.params.id; //console.log(this.iduser);
        ...
        _createClass(ProfileComponent, [{
          ...
          value: function getPosts(userId) {
            ...
            this._userService.getPosts(userId).subscribe(function (response) {
              if (response.status == 'success') {
                // console.log(response);
                _this6.posts = response.post; //console.log(this.posts);

                _this6.page_title = "Post de ".concat(_this6.posts[0].user.name, " ").concat(_this6.posts[0].user.surname);
              }
            }, function (error) {});
          }
        }]);
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _services_post_service__WEBPACK_IMPORTED_MODULE_5__["PostService"], src_app_services_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"]])], ProfileComponent);
      /***/
    },
    ...
    function ENZJ(module, __webpack_exports__, __webpack_require__) {
      ...
      var _apiglobal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./apiglobal */
      "XvYk");
      ...
      var PostService = /*#__PURE__*/function () {
        ...
        _createClass(PostService, [{
          ...
          value: function create(token, post) {
            ...
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', token);
          ...
          key: "updatepost",
          value: function updatepost(token, post, id) {
            post.content = _apiglobal__WEBPACK_IMPORTED_MODULE_3__["urlglobal"].htmlEntities(post.content);
            var json = JSON.stringify(post);
            var params = "json=" + json;
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', token);
          ...
          key: "deletePost",
          value: function deletePost(token, id) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', token);
      ...
      PostService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], PostService);
      /***/
    },
    ...
    /***/
    function FNOU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var Post = function Post(id, user_id, category_id, content, image, createdAt) {
    ...
    /***/
    function FOWj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function HfIm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function MSij(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_category_new_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./category-new.component.html */
      "3FbO");
      /* harmony import */


      var _category_new_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./category-new.component.css */
      "dJeq");
      /* harmony import */
      ...
      var _models_categoty__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../models/categoty */
      "Uigi");
      /* harmony import */
      ...
      var CategoryNewComponent = /*#__PURE__*/function () {
        function CategoryNewComponent(_userService, _categoryService, _router, _activateroute) {
        ...
        _createClass(CategoryNewComponent, [{
          ...
          key: "enviarnewCategoria",
          value: function enviarnewCategoria(form) {
            var _this7 = this;

            console.log(this.category);

            this._categoryService.addnewCategory(this.token, this.category).subscribe(function (response) {
              _this7.status = response.status; // console.log("HABEr", response);
      ...
      CategoryNewComponent.ctorParameters = function () {
        return [{
      ...
      CategoryNewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"], _services_category_service__WEBPACK_IMPORTED_MODULE_7__["CategoryService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["ActivatedRoute"]])], CategoryNewComponent);
      /***/
    },
    ...
    /***/
    function QmUL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      IdentityGuard.ctorParameters = function () {
        return [{
      ...
      IdentityGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_user_service__WEBPACK_IMPORTED_MODULE_3__["UserService"]])], IdentityGuard);
      /***/
    },
    ...
    function RUEf(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./components/user-edit/user-edit.component */
      "24cc");
      /* harmony import */


      var _components_category_new_category_new_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./components/category-new/category-new.component */
      "MSij");
      /* harmony import */


      var _components_post_new_post_new_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./components/post-new/post-new.component */
      "BNuL");
      /* harmony import */


      var _components_post_detail_post_detail_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./components/post-detail/post-detail.component */
      "S3qa");
      /* harmony import */


      var _components_post_edit_post_edit_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./components/post-edit/post-edit.component */
      "sJZg");
      /* harmony import */


      var _components_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./components/category-detail/category-detail.component */
      "lvAC");
      /* harmony import */


      var _identity_guard__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./identity.guard */
      "QmUL");
      /* harmony import */
      ...
      var ROUTES = [{
        ...
        path: 'ajustes',
        component: _components_user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_6__["UserEditComponent"],
        canActivate: [_identity_guard__WEBPACK_IMPORTED_MODULE_12__["IdentityGuard"]]
      }, {
        path: 'crear-categoria',
        component: _components_category_new_category_new_component__WEBPACK_IMPORTED_MODULE_7__["CategoryNewComponent"],
        canActivate: [_identity_guard__WEBPACK_IMPORTED_MODULE_12__["IdentityGuard"]]
      }, {
        path: 'crear-post',
        component: _components_post_new_post_new_component__WEBPACK_IMPORTED_MODULE_8__["PostNewComponent"],
        canActivate: [_identity_guard__WEBPACK_IMPORTED_MODULE_12__["IdentityGuard"]]
      }, {
        path: 'entrada/:id',
        component: _components_post_detail_post_detail_component__WEBPACK_IMPORTED_MODULE_9__["PostDetailComponent"]
      }, {
        path: 'editar-entrada/:id',
        component: _components_post_edit_post_edit_component__WEBPACK_IMPORTED_MODULE_10__["PostEditComponent"],
        canActivate: [_identity_guard__WEBPACK_IMPORTED_MODULE_12__["IdentityGuard"]]
      }, {
        path: 'registro',
        ...
        path: 'categoria/:id',
        component: _components_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_11__["CategoryDetailComponent"]
      }, {
        path: 'categorias',
        component: _components_categorias_categorias_component__WEBPACK_IMPORTED_MODULE_5__["CategoriasComponent"]
      }, {
        path: 'error',
    ...
    /***/
    function S3qa(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_post_detail_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./post-detail.component.html */
      "vP5Q");
      /* harmony import */


      var _post_detail_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _services_post_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../services/post.service */
      "ENZJ");

      var PostDetailComponent = /*#__PURE__*/function () {
        function PostDetailComponent(_userService, _http, _postService, _route, _activeRoute) {
        ...
        _createClass(PostDetailComponent, [{
          ...
          value: function getPost() {
            ...
            this._activeRoute.params.subscribe(function (response) {
              var id = +response['id']; //console.log(id);

              _this8._postService.getPost(id).subscribe(function (data) {
                if (data.status == 'success') {
                  _this8.post = data.posts; //console.log(data.posts);
                } else {
                  _this8._route.navigate(['home']);
                }
              }, function (error) {
                _this8._route.navigate(['home']); // console.log(error);
      ...
      PostDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"], _services_post_service__WEBPACK_IMPORTED_MODULE_7__["PostService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"]])], PostDetailComponent);
      /***/
    },
    ...
    function Sy1n(module, __webpack_exports__, __webpack_require__) {
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(_userService, _categoryServie) {
        ...
        _createClass(AppComponent, [{
          ...
          value: function getCategories() {
            ...
            this._categoryServie.getCategories().subscribe(function (response) {
              if (response.status == 'success') {
                _this9.categories = response.categories; //console.log(this.categories);
              }
            }, function (error) {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_4__["UserService"], _services_category_service__WEBPACK_IMPORTED_MODULE_6__["CategoryService"]])], AppComponent);
      /***/
    },
    ...
    /***/
    function Uigi(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function W3Zi(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(_userService, _router, _activateroute) {
        ...
        _createClass(LoginComponent, [{
          ...
          key: "enviarLogin",
          value: function enviarLogin(form) {
            var _this10 = this;

            this._userService.signup(this.user).subscribe(function (response) {
              if (response.status == 'error') {
                _this10.status = 'Contraseña o Password Incorrectos';
                return;
              }

              console.log("RSA", response); // Token

              _this10.status = 'success';
              _this10.token = response;

              _this10._userService.signup(_this10.user, true).subscribe(function (response) {
                console.log("RSA", response); // User information

                _this10.identity = response;
                console.log("toke", _this10.token);
                console.log("User identidaD", _this10.identity); // PERSISTIR DATOS

                localStorage.setItem('token', _this10.token);
                localStorage.setItem('identity', JSON.stringify(_this10.identity)); // Redireccion a INICIO

                _this10._router.navigate(['home']);
              }, function (error) {
          ...
          value: function logout() {
            ...
            this._activateroute.params.subscribe(function (dato) {
              var logout = +dato['sure']; // Con el ma antes de dato lo convierto a int

              if (logout == 1) {
                localStorage.removeItem('identity');
                localStorage.removeItem('token');
                _this11.identity = null;
                _this11.token = null; // Redireccion a INICIO

                _this11._router.navigate(['home']);
              }
            });
          }
        }]);
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["ActivatedRoute"]])], LoginComponent);
      /***/
    },
    ...
    function XC3f(module, __webpack_exports__, __webpack_require__) {
      ...
      var RegisterComponent = /*#__PURE__*/function () {
        ...
        _createClass(RegisterComponent, [{
          key: "enviarRegistro",
          value: function enviarRegistro(form) {
            var _this12 = this;

            // console.log(this.user);
            this._userService.register(this.user).subscribe(function (response) {
              // console.log("databack",response);
              _this12.status = 'success';
              form.reset();
            }, function (error) {
              //console.log("HYA UN ERROR" , error);
              var emailcheck = error.error.nameerror.email.length;

              if (emailcheck) {
                // console.log("El email ya existe");
                _this12.status = 'El email ya existe';
              }
            });
          }
        }, {
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_user_service__WEBPACK_IMPORTED_MODULE_5__["UserService"]])], RegisterComponent);
      /***/
    },
    ...
    /***/
    function XvYk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "urlglobal", function () {
        return urlglobal;
      });
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var froala_editor_js_plugins_pkgd_min_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! froala-editor/js/plugins.pkgd.min.js */
      "rcg+");
      /* harmony import */


      var froala_editor_js_plugins_pkgd_min_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(froala_editor_js_plugins_pkgd_min_js__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */
      ...
      var _components_categorias_categorias_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./components/categorias/categorias.component */
      "+1dx");
      /* harmony import */
      ...
      var _components_user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./components/user-edit/user-edit.component */
      "24cc");
      /* harmony import */


      var _components_category_new_category_new_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./components/category-new/category-new.component */
      "MSij");
      /* harmony import */


      var _components_post_new_post_new_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ./components/post-new/post-new.component */
      "BNuL");
      /* harmony import */


      var _pipes_imagenone_pipe__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
      /*! ./pipes/imagenone.pipe */
      "cnrC");
      /* harmony import */


      var _components_post_detail_post_detail_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
      /*! ./components/post-detail/post-detail.component */
      "S3qa");
      /* harmony import */


      var _components_post_edit_post_edit_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
      /*! ./components/post-edit/post-edit.component */
      "sJZg");
      /* harmony import */


      var _components_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
      /*! ./components/category-detail/category-detail.component */
      "lvAC");
      /* harmony import */


      var _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(
      /*! ./components/profile/profile.component */
      "DZ0t"); // FROALA EDITOR
      // File UpLoader
      ...
      AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_login_login_component__WEBPACK_IMPORTED_MODULE_8__["LoginComponent"], _components_register_register_component__WEBPACK_IMPORTED_MODULE_9__["RegisterComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_11__["HomeComponent"], _components_error_error_component__WEBPACK_IMPORTED_MODULE_12__["ErrorComponent"], _components_categorias_categorias_component__WEBPACK_IMPORTED_MODULE_13__["CategoriasComponent"], _components_user_edit_user_edit_component__WEBPACK_IMPORTED_MODULE_15__["UserEditComponent"], _components_category_new_category_new_component__WEBPACK_IMPORTED_MODULE_16__["CategoryNewComponent"], _components_post_new_post_new_component__WEBPACK_IMPORTED_MODULE_17__["PostNewComponent"], _pipes_imagenone_pipe__WEBPACK_IMPORTED_MODULE_18__["ImagenonePipe"], _components_post_detail_post_detail_component__WEBPACK_IMPORTED_MODULE_19__["PostDetailComponent"], _components_post_edit_post_edit_component__WEBPACK_IMPORTED_MODULE_20__["PostEditComponent"], _components_category_detail_category_detail_component__WEBPACK_IMPORTED_MODULE_21__["CategoryDetailComponent"], _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_22__["ProfileComponent"]],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _app_routes__WEBPACK_IMPORTED_MODULE_10__["ROUTING"], _angular_common_http__WEBPACK_IMPORTED_MODULE_14__["HttpClientModule"], angular_froala_wysiwyg__WEBPACK_IMPORTED_MODULE_4__["FroalaEditorModule"].forRoot(), angular_froala_wysiwyg__WEBPACK_IMPORTED_MODULE_4__["FroalaViewModule"].forRoot(), angular_file_uploader__WEBPACK_IMPORTED_MODULE_6__["AngularFileUploaderModule"]],
        providers: [_app_routes__WEBPACK_IMPORTED_MODULE_10__["APPROUTINGPROVIDERS"]],
    ...
    /***/
    function b0ZK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function b5y5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function cPV5(module, __webpack_exports__, __webpack_require__) {
      ...
      var _apiglobal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./apiglobal */
      "XvYk");
      /* harmony import */
      ...
      var CategoryService = /*#__PURE__*/function () {
        ...
        _createClass(CategoryService, [{
          key: "addnewCategory",
          value: function addnewCategory(token, category) {
            var json = JSON.stringify(category); // El backend solo lee un String, 
            // y pues ese string se codifica a JSON en el backend

            var params = 'json=' + json; // key: json 
            // value de json de user
            // COMO EN POSTMAN !! WUUAO

            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded').set('Authorization', token); // Indico las cabecera 
          ...
          key: "getCategories",
          value: function getCategories() {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'aplication/x-www-form-urlencoded');
          ...
          value: function getCategory(id) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'aplication/x-www-form-urlencoded');
            return this.http.get("".concat(this.url, "category/").concat(id), {
              headers: headers
            });
          }
        }, {
          ...
          value: function getPosts(id) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpHeaders"]().set('Content-Type', 'aplication/x-www-form-urlencoded');
            return this.http.get("".concat(this.url, "post/category/").concat(id), {
              headers: headers
            });
          }
        }]);
      ...
      CategoryService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]])], CategoryService);
      /***/
    },
    ...
    /***/
    function cnrC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ImagenonePipe", function () {
        return ImagenonePipe;
      });
      /* harmony import */
      ...
      var ImagenonePipe = /*#__PURE__*/function () {
        function ImagenonePipe(_http) {
          _classCallCheck(this, ImagenonePipe);

          this._http = _http;
          this.url = 'assets/image/noimage.png';
        }

        _createClass(ImagenonePipe, [{
          key: "transform",
      ...
      ImagenonePipe.ctorParameters = function () {
        return [{
          type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
        }];
      };

      ImagenonePipe = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Pipe"])({
        name: 'imagenone'
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], ImagenonePipe);
      /***/
    },
    ...
    /***/
    function csMw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function dJeq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function j6lq(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<h1>{{ page_title }}</h1>\n<p>\n  categorias works!\n</p>\n";
      /***/
    },
    ...
    /***/
    function lQtD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function lvAC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_category_detail_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./category-detail.component.html */
      "IocU");
      /* harmony import */


      var _category_detail_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _services_category_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../services/category.service */
      "cPV5");
      /* harmony import */
      ...
      var CategoryDetailComponent = /*#__PURE__*/function () {
        function CategoryDetailComponent(_activeRoute, _categoryService, _userService, _postService) {
        ...
        _createClass(CategoryDetailComponent, [{
          ...
          key: "getPostByCategory",
          value: function getPostByCategory() {
            var _this13 = this;

            this._activeRoute.params.subscribe(function (data) {
              var id = +data['id'];

              _this13._categoryService.getCategory(id).subscribe(function (response) {
                if (response.status == 'success') {
                  _this13.category = response.category; //console.log(response); 
                  //console.log(this.category.id);

                  console.log(_this13.identity.sub);
                  console.log(_this13.category.user_id);
                }
              }, function (error) {
                return console.log(error);
              });

              _this13._categoryService.getPosts(id).subscribe(function (response) {
                if (response.status == 'success') {
                  console.log("Aui postbycategory", response.post);
                  _this13.posts = response.post;
                }
              }, function (error) {
      ...
      CategoryDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _services_category_service__WEBPACK_IMPORTED_MODULE_5__["CategoryService"], _services_user_service__WEBPACK_IMPORTED_MODULE_7__["UserService"], _services_post_service__WEBPACK_IMPORTED_MODULE_8__["PostService"]])], CategoryDetailComponent);
      /***/
    },
      ...
      var UserService = /*#__PURE__*/function () {
        ...
        _createClass(UserService, [{
          ...
          value: function register(user) {
            var json = JSON.stringify(user); // El backend solo lee un String, 
            // y pues ese string se codifica a JSON en el backend
            ...
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/x-www-form-urlencoded'); // Indico las cabecera 
          ...
          key: "updateuser",
          value: function updateuser(token, user) {
            user.description = _apiglobal__WEBPACK_IMPORTED_MODULE_3__["urlglobal"].htmlEntities(user.description);
            var json = JSON.stringify(user); // Lo convierto a string para enviarlo al API
          ...
          key: "traerUser",
          value: function traerUser(id) {
            return this.http.get(this.url + 'user/detail/' + id);
          }
        }, {
          key: "getPosts",
          value: function getPosts(id) {
            var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'aplication/x-www-form-urlencoded');
            return this.http.get("".concat(this.url, "post/user/").concat(id), {
              headers: headers
            });
          }
        }]);
    ...
    /***/
    function sJZg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _post_edit_component_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _services_apiglobal__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../services/apiglobal */
      "XvYk");
      /* harmony import */
      ...
      var PostEditComponent = /*#__PURE__*/function () {
        function PostEditComponent(_activeRoute, _postService, _userService, _categoryService, _router) {
          var _this15 = this;
          ...
          this._activeRoute.params.subscribe(function (data) {
            ...
            _postService.getPost(_this15.id).subscribe(function (response) {
              if (response.status == 'success') {
                //console.log(response.posts);
                delete response.posts['user'];
                _this15.post = response.posts;
                var userid = +_this15.post.user_id; // Comprobar si el dueño del POST, para editar
                // Toco casting a int porque son string, pues eso dice el EDITOR

                if (userid != +_this15.identity.sub) {
                  _this15._router.navigate(['/home']);
                }
              }
            }, function (error) {});
          });
        ...
        _createClass(PostEditComponent, [{
          ...
          key: "editpost",
          value: function editpost(form) {
            var _this16 = this;

            console.log(this.post);

            this._postService.updatepost(this.token, this.post, this.id).subscribe(function (response) {
              if (response.status == 'success') {
                _this16.status = response.status;
              }
            }, function (error) {
              console.log(error);
            });
          ...
          value: function getCategories() {
            ...
            this._categoryService.getCategories().subscribe(function (response) {
              // console.log(response.categories);
              _this17.categories = response.categories;
            });
          }
        }, {
          key: "ImagenUpload",
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"], _services_post_service__WEBPACK_IMPORTED_MODULE_5__["PostService"], _services_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _services_category_service__WEBPACK_IMPORTED_MODULE_8__["CategoryService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], PostEditComponent);
      /***/
    },
    ...
    /***/
    function vP5Q(module, __webpack_exports__, __webpack_require__) {
      "use strict";
